        ...
        final sliderButton = widget.customSliderButton ??
            Container(
              ...
              decoration: BoxDecoration(
                color: theme.sliderButtonColor ?? Colors.white,
                border: Border.all(
                  color: theme.sliderButtonBorderColor ?? Colors.grey,
                ),
                borderRadius:
                    theme.sliderButtonBorderRadius ?? BorderRadius.circular(6),
              ),
            );
              ...
              children: [
                CustomPaint(
                  ...
                  painter: _AudioBarsPainter(
                    ...
                    colorLeft: theme.waveColorPlayed ?? widget.colorLeft,
                    colorRight: theme.waveColorUnplayed ?? widget.colorRight,
